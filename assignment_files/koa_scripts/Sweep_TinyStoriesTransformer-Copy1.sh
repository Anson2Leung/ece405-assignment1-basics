#!/bin/bash
#SBATCH --job-name=ECE405_7.2LR_a
#SBATCH --gres=gpu:1
...
for LR in 3e-5 1e-4 3e-4 6e-4 1e-3; do
    echo "========================================="
    ...
    uv run python -m assignment_files.TrainLoop \
        ...
        --checkpoint_dir  /home/ansonl32/koa_scratch/ECE405/assignment1-basics/checkpoints/lr_${LR} \
        --wandb_project   ece405 \
        --wandb_run_name  "a_lr_${LR}"
done